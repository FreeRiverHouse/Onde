...
def run_pipeline(input_file: str, output_dir: str):
    print("""
╔═══════════════════════════════════════════════════════════════════╗
║  🚀 TRANSLATION PIPELINE MLX v11.0 - QWEN3-32B OTTIMIZZATO        ║
║  📍 /no_think prompt per risposte dirette senza reasoning         ║
║  📍 Pulizia automatica token Qwen3 e slop detection               ║
╚═══════════════════════════════════════════════════════════════════╝
""")
