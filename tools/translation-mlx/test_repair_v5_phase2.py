...
# TEST INDICES PHASE 2: Hard/Mixed
indices_to_test = [9, 12, 26, 47]
# 9: "1. The argument in brief" (EN)
# 12: "Fetters - Libertà - Innovazione..." (IT with weird dashes)
# 26: "2. Before and after neoliberalism" (EN)
# 47: "Il 'desiderio elementare di essere liberi'" (IT with quotes)

print(f"=== FASE 2: TEST SU 4 PARAGRAFI DIFFICILI ({indices_to_test}) ===")
