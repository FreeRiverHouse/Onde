...
| 101 | PERF-002 | Skin Creator: Code-split 4357-line page.tsx into lazy-loaded components | 🔥 Performance | TODO | - | TBT=2.5s, JS eval=4.2s. Split color picker, layer panel, gallery into dynamic imports |
