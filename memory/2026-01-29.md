...
La memoria non funziona! Mattia si è lamentato che non ricordo le cose.

### Decisione Importante
Kalshi è stato scelto proprio perché scoperto tramite PredictionArena research.
...
- **T660**: Add RULE N3 to REGOLE-AGENTI.md ✅ DONE
...
**QUESTA È LA REGOLA PIÙ IMPORTANTE DOPO GIT!**
...
|------|-------------|--------|
| T656 | Fix Clawdbot memory persistence | ✅ DONE |
| T657 | Fix Clawdinho memory persistence | ✅ DONE |
| T658 | Fix Onde-bot memory persistence | ✅ DONE |
| T659 | Universal memory engagement rules | ✅ DONE |
| T660 | Add RULE N3 to REGOLE-AGENTI.md | ✅ DONE (by Clawdinho) |
