# EMILIO YouTube Video Script #2

## Video Info
- **Titolo**: EMILIO Spiega: Cos'è un Robot | Tech per Bambini
- **Durata target**: 3-5 minuti
- **Canale**: Onde / EMILIO
- **Lingua**: Italiano (+ sottotitoli EN, ES, DE, FR, PT)

## Hook (0:00 - 0:15)
EMILIO: "Ciao amici! Oggi vi svelo un SEGRETO incredibile su Cos'è un Robot!
...
EMILIO: "Vi siete mai chiesti come funziona Cos'è un Robot?"
