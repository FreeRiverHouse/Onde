...
export default function BookReader() {
  ...
  // Notte: blu profondo magico, turchese, oro
  // Giorno: bianco luminoso, turchese, oro
  // Seppia: crema calda, turchese scuro, oro
  const themeStyles = {
    notte: {
  ...
  return (
    <div className={`min-h-screen ${t.bg} transition-all duration-500`}>
      {/* Progress bar - Onde gold gradient */}
      ...
      {/* Book Header - Elegant Onde style */}
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 pb-24" ref={contentRef}>
        {loading ? (
          ...
          <>
            ...
            {/* Book text - Beautiful typography */}
            <article
