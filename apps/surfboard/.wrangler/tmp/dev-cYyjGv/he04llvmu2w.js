...
// .wrangler/tmp/bundle-ghwYLr/checked-fetch.js
...
// .wrangler/tmp/pages-Tnhk5q/bundledWorker-0.6785547595434934.mjs
...
async function k(e, { request: t, assetsFetcher: n, ctx: s }, { path: a, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        r = S(await n.fetch(j(c, e.path ?? a))), e.headers && w(r.headers, e.headers);
        break;
      }
      case "static": {
...
async function J(e) {
  ...
  try {
    let n = new URL(e.url), s = await we();
    ...
    switch (e.method) {
      case "GET": {
        let i = W(e, ge), r = await s.get(a, { softTags: i });
...
var T = class {
  ...
  applyRouteHeaders(t, n, s) {
    !t.headers || (w(this.headers.normal, t.headers, { match: n, captureGroupKeys: s }), t.important && w(this.headers.important, t.headers, { match: n, captureGroupKeys: s }));
  }
  applyRouteStatus(t) {
...
async function Me(e, { path: t = "/404", status: n, headers: s, searchParams: a, body: i }, r) {
  ...
  let h = s.normal;
  return w(h, c.headers), w(h, s.important), c = new Response(c.body, { ...c, status: n || c.status, headers: h }), c;
}
__name(Me, "Me");
__name2(Me, "Me");
u();
...
// .wrangler/tmp/pages-Tnhk5q/he04llvmu2w.js
...
// .wrangler/tmp/bundle-ghwYLr/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ghwYLr/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=he04llvmu2w.js.map
