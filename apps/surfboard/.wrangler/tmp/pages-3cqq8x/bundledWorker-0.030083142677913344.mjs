...
function Ie() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name((t, n) => e.has(n) ? e.get(n) : Reflect.get(globalThis, n), "get"), set: /* @__PURE__ */ __name((t, n, s) => je.has(n) ? Reflect.set(globalThis, n, s) : (e.set(n, s), true), "set") });
}
__name(Ie, "Ie");
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.030083142677913344.mjs.map
