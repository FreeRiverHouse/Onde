...
// .wrangler/tmp/pages-3cqq8x/bundledWorker-0.030083142677913344.mjs
...
var q = V((ze, F) => {
  ...
  function R(e, t) {
    ...
    }), e = e.replace(/\[:([^:]+):\]/g, (o, c) => R.characterClasses[c] || o), new R.PCRE(e, a, n, a, s);
  }
  __name(R, "R");
  __name2(R, "R");
  function de(e, t) {
...
async function k(e, { request: t, assetsFetcher: n, ctx: s }, { path: a, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        r = S(await n.fetch(L(c, e.path ?? a))), e.headers && _(r.headers, e.headers);
        break;
      }
      case "static": {
        r = await n.fetch(L(c, a));
        break;
      }
      default:
...
var T = class {
  ...
  checkRouteMatch(t, { checkStatus: n, checkIntercept: s }) {
    ...
    }) && !t.missing?.find((r) => A(r, i).valid) && !(n && t.status !== this.status)) {
      if (s && t.dest) {
  ...
  processMiddlewareResp(t) {
    ...
    if (i) {
      ...
      this.path = h ? `${c}` : c.pathname, x(this.searchParams, c.searchParams), t.headers.delete(a);
    }
  ...
  applyRouteDest(t, n, s) {
    ...
    return x(this.searchParams, w.searchParams), v(this.path) || (this.path = w.pathname), a;
  }
  ...
  async checkPhase(t) {
    ...
    let a = "miss";
    return s || t === "miss" || t === "error" ? a = "hit" : n && (a = H(t)), this.checkPhase(a);
  }
  async run(t = "none") {
...
function Ie() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name2((t, n) => e.has(n) ? e.get(n) : Reflect.get(globalThis, n), "get"), set: /* @__PURE__ */ __name2((t, n, s) => je.has(n) ? Reflect.set(globalThis, n, s) : (e.set(n, s), true), "set") });
}
__name(Ie, "Ie");
__name2(Ie, "Ie");
...
// .wrangler/tmp/pages-3cqq8x/byazjcpjk5a.js
...
// .wrangler/tmp/bundle-hiiX4D/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-hiiX4D/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=byazjcpjk5a.js.map
