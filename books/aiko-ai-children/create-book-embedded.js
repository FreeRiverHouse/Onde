...
<div class="page cover-page">
  <img src="${coverImg}" alt="AIKO Cover">
  <h1>AIKO</h1>
...
<div class="page chapter-page">
  ...
  <div class="chapter-image">
    <img src="${ch1Img}" alt="Sofia discovers AIKO">
  </div>
...
<div class="page chapter-page">
  ...
  <div class="chapter-image">
    <img src="${ch2Img}" alt="Brain vs Circuits">
  </div>
  <div class="chapter-text">
...
<div class="page chapter-page">
  ...
  <div class="chapter-image">
    <img src="${ch3Img}" alt="AIKO learning to see">
  </div>
  <div class="chapter-text">
    ...
    <p class="dialogue">"A cat,"</p> said AIKO immediately.
    ...
    <p class="dialogue">"After seeing so many, I started to notice things. Cats have pointy ears. Whiskers. Fluffy tails. Now when I see something new, I compare it to everything I've learned."</p>
    <p>Sofia looked at Whiskers, then at AIKO. <span class="dialogue">"I only needed to see ONE cat to know what a cat is."</span></p>
    <p class="dialogue">"That's amazing. Your brain learns faster than I do in some ways."</p>
  </div>
</div>
...
<div class="page chapter-page">
  ...
  <div class="chapter-image">
    <img src="${ch4Img}" alt="AIKO learning to talk">
  </div>
  <div class="chapter-text">
    ...
    <p>Luca sat down. <span class="dialogue">"How DO you talk, AIKO? You sound almost like a real person."</span></p>
...
<div class="page chapter-page">
  ...
  <div class="chapter-text">
    ...
    <p><span class="dialogue">"That's a very grown-up question,"</span> said Mom. <span class="dialogue">"AIKO, what should kids know?"</span></p>
    ...
    <p class="dialogue"><strong>THREE:</strong> Use AI to learn more, not less. Let me help you LEARN.</p>
    <p class="dialogue"><strong>FOUR:</strong> Real friends matter most. I can't give you a hug when you're sad."</p>
  </div>
</div>
...
<div class="page chapter-page">
  ...
  <div class="chapter-image">
    <img src="${ch8Img}" alt="The future together">
  </div>
  <div class="chapter-text">
    ...
    <p>Sofia picked a blade of grass. <span class="dialogue">"So we're like... a team?"</span></p>
...
<div class="page notes-page">
  ...
  <ul>
    ...
    <li><strong>Human superiority:</strong> Humans can learn from one example; AI needs thousands</li>
    <li><strong>Safety:</strong> Privacy, verification, balance, valuing real relationships</li>
    <li><strong>Collaboration:</strong> AI as a tool that helps, humans as decision-makers</li>
  </ul>
...
// Write HTML file
fs.writeFileSync('output/AIKO-book-embedded.html', bookContent);
console.log('HTML with embedded images created: output/AIKO-book-embedded.html');
